    ...
    rollupOptions: {
      output: {
        manualChunks: {
          ...
          "vendor-data": ["zustand", "dexie", "date-fns"],
          "heavy-charts": ["chart.js", "react-chartjs-2"],
          "heavy-office": ["xlsx", "mammoth", "docx"],
          "heavy-pdf": ["pdfjs-dist"],
          "heavy-ocr": ["tesseract.js"],
          "heavy-math": ["katex", "react-katex"],
        },
      },
    },
  },
